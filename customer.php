                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        <a href="add.php" class="btn btn-success mr-3 mb-3">Add</a>
                                        <thead>
                                            <tr>
                                                <th>Name</th>
                                                <th>Postal Code</th>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="delete.php?id=<?= $row["customerID"]; ?>" class="btn btn-danger mb-3" onclick="return confirm('Are you sure you want to delete this?')">
                                                            Delete
                                                        </a>
                                                        <a href="edit.php?id=<?= $row["customerID"]; ?>" class="btn btn-warning mb-3">Edit</a>
                                                    </td>
                                                </tr>
                                            <?php
                                            }
